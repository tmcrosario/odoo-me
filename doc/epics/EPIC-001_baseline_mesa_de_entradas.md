...
| TASK-003 | Baseline de tests (inventario y gaps) | sin asignar | M | `me` | Draft |
| TASK-004 | Investigación: filtrado de jurisdicciones del DEM (#033) | sin asignar | M | `me` | Draft |
