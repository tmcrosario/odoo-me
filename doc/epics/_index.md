...
| EPIC-004 | Reacotamiento de la carga de ME: traspaso de clasificación a JUNCO | `me` (+ `junco`) | Draft | L/sensible. ME cede solo jurisdiction/source → JUNCO; conserva subject/specification/reference (tema/subtema/objeto); rediseña movimientos. Requiere `/product-spec`. Cruza contrato EPIC-002 |
