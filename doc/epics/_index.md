...
| EPIC-004 | Reacotamiento de la carga de ME: traspaso de clasificación a JUNCO | `me` (+ `junco`) | Draft | XL/sensible. ME deja de cargar jurisdiction/source/subject/object → JUNCO; rediseña movimientos. Requiere `/product-spec`. Cruza contrato EPIC-002 |
