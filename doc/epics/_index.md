...
| EPIC-003 | Usabilidad y filtros de la vista de expedientes | `me` | Done (develop) | Filtros por usuario (S) y por oficina interna de destino (L); TASK-003: orden de lista por `intake_date` desc (XS). Tasks Done; UI verificada. Deploy a prod diferido |
