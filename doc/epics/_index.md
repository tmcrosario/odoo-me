...
| EPIC-003 | Usabilidad y filtros de la vista de expedientes | `me` | Done (develop) | Filtros por usuario (S) y por oficina interna de destino (L); TASK-003: orden por `intake_date` desc; TASK-004: búsqueda/group-by por Jurisdicción (cierra IDEA 1). Tasks Done; UI verificada. Deploy a prod diferido |
| EPIC-004 | Reacotamiento de la carga de ME: traspaso de clasificación a JUNCO | `me` (+ `junco`) | Done (develop) | TASK-001: DEM cede jurisdiction/source a JUNCO vía `action_set_origin_from_junco`; 1er movimiento DEM→TMC desacoplado. **TASK-002**: excepción DEM+Nota (no van a JUNCO → ME carga al ingreso) + validaciones de fecha + label i18n. **TASK-003**: 1er movimiento de Nota desde la jurisdicción. **TASK-004**: subtema de Licitación acotado a Privada/Pública (coordinado con junco). **TASK-005**: subtema de Licitación **requerido** (upstream de JUNCO). **TASK-006**: tema requerido al alta + filtro "Sin clasificar" (compra sin tema no queda invisible para JUNCO). Suite 254/0/0. Validada end-to-end en me2; deploy a prod diferido. Contraparte junco EPIC-010 Done (+ EPIC-010/TASK-003 Done, `53e7d98`: constraint backend en `junco.process_expediente` → BR-005 con doble enforcement) |
...
| EPIC-006 | Usabilidad del formulario de expedientes | `me` | En progreso (develop) | TASK-001: botón "Save" dirty-only (primer asset frontend de `me`). TASK-002: indicador "En Legajo Nº X" + filtro "Adjuntos a Legajo". Suite 246/0/0; UI verificada. Épica abierta para más mejoras |
