...
| EPIC-004 | Reacotamiento de la carga de ME: traspaso de clasificación a JUNCO | `me` (+ `junco`) | Draft | L/sensible. ME cede jurisdiction/source a JUNCO **solo para DEM/CM compras** (TMC intacto, conserva source); conserva subject/specification/reference; rediseña movimientos DEM. Requiere `/product-spec`. Cruza contrato EPIC-002 |
